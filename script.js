...
// Random Roast (avoids repeating the same one back-to-back)
...
function getRoast(){
    ...
    if(customCategories[cat]){
        ...
        lastUsedCategory = cat;
        list = window.roastData[lang][cat];
    ...
    } while(pick === lastRoastTemplate && list.length > 1 && attempts < 15);
